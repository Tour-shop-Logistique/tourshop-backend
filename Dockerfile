...
# 1b. Supprimer le warning ServerName
...
# 6. Configuration du dossier racine d'Apache
...
# 11. Correction dynamique du port au démarrage (Render injecte $PORT)
# Cette commande s'assure qu'au runtime, Apache écoute sur le bon port fourni par Render
